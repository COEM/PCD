 ...
 * @author Wiki
 */
public class peningkatan_kualitas_citra extends javax.swing.JFrame {
    ...
    public peningkatan_kualitas_citra() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(peningkatan_kualitas_citra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new peningkatan_kualitas_citra().setVisible(true);
            }
        });
    }
