...
public static String sumbergambar;
static String gb1,gb2;
    /**
    ...
    public Open(GraphicsConfiguration gc) {
        super(gc);
    }
    Image image;
    Dimension size;
    ...
    Graphics g;
    int binergray,RGB,alpha,red,green,blue,avg,gray,inv,invpx;
    ...
    private void initComponents() {
        ...
        jButton6.setText("Histogram Equalization");
        ...
        jMenuItem3.setText("0.5r + 0.2g + 0.3b");
        ...
        jMenuItem4.setText("0.2r + 0.5g + 0.3b");
        ...
        jMenuItem5.setText("0.2r + 0.3g + 0.5b");
        ...
        jMenuItem6.setText("0.5r + 0.5g + 0b");
        ...
        jMenuItem7.setText("0.5r + 0g + 0.5b");
        ...
        jMenu6.setText("Deteksi Tepi");

        jMenuItem17.setText("Prewitte");
        ...
        jMenuItem18.setText("Gausian 5x5");
        ...
        jMenuItem19.setText("Sobel1 3x3");
        ...
        jMenuItem21.setText("Sobel2 3x3");
        ...
        jMenuItem22.setText("Sobel3 3x3");
    ...
    if (open == JFileChooser.APPROVE_OPTION)
    {
     ...
     jLabel1.setIcon(new ImageIcon(new ImageIcon(sumbergambar).getImage().getScaledInstance(jLabel1.getWidth(), jLabel1.getHeight(), Image.SCALE_DEFAULT)));
     jButton4.enable();
     jButton5.enable();
    }
    ...
    for (int x = 0; x < size.width; x++){
        for (int y = 0; y < size.height; y++){
            RGB = prosesimage.getRGB(x, y);
            alpha = (RGB << 24) & 0xFF;
            red = (RGB >> 16) & 0xFF;
            green = (RGB >> 8) & 0xFF;
            blue = (RGB >> 0) & 0xFF;
            avg = (red + green + blue) / 3;
            gray = alpha | avg << 16 | avg << 8 | avg ;
            prosesimage.setRGB(x, y, gray);
        }
    }
    jLabel2.setIcon(new ImageIcon(new ImageIcon(prosesimage).getImage().getScaledInstance(jLabel2.getWidth(), jLabel2.getHeight(), Image.SCALE_DEFAULT)));
    ...
    for (int x = 0; x < size.width; x++){
        for (int y = 0; y < size.height; y++){
            ...
            prosesimage.setRGB(x, y, gray);
            inv = 255 - avg;
            invpx = alpha | inv << 16 | inv << 8 | inv;
            prosesimage3.setRGB(x, y, invpx);
        }
    }
    jLabel1.setIcon(new ImageIcon(new ImageIcon(prosesimage).getImage().getScaledInstance(jLabel1.getWidth(), jLabel1.getHeight(), Image.SCALE_DEFAULT)));
    jLabel2.setIcon(new ImageIcon(new ImageIcon(prosesimage3).getImage().getScaledInstance(jLabel2.getWidth(), jLabel2.getHeight(), Image.SCALE_DEFAULT)));
    ...
    for (int x = 0; x < size.width; x++){
        for (int y = 0; y < size.height; y++){
            ...
            gray = alpha | avg << 16 | avg << 8 | avg;
            prosesimage.setRGB(x, y, gray);
            inv = (int) (Integer.parseInt(jTextField2.getText()) * (Math.log10(255 - avg + 1)));
            invpx = alpha | inv << 16 | inv << 8 | inv;
            prosesimage3.setRGB(x, y, invpx);
        }
    }
    ...
    if (jLabel1.getIcon()==null) {
            JOptionPane.showMessageDialog(rootPane, "Pilih gambar dulu");
        }else{
            image = new ImageIcon(sumbergambar).getImage();
            size = new Dimension();
            size.width = image.getWidth(null);
            ...
            for (int x = 0; x < size.width; x++) {
                for (int y = 0; y < size.height; y++) {
                    ...
                    green = (RGB >> 8) & 0xFF;
                    blue = (RGB >>0) & 0xFF;
                    avg =(int) ((red*0.2) + (green * 0.5) + (blue * 0.3));
                    gray = alpha | avg << 16 | avg << 8 | avg;
                    prosesimage.setRGB(x, y, gray);
                }
            }
    ...
    if (jLabel1.getIcon()==null) {
            ...
            for (int x = 0; x < size.width; x++) {
                for (int y = 0; y < size.height; y++) {
                    ...
                    green = (RGB >> 8) & 0xFF;
                    blue = (RGB >>0) & 0xFF;
                    avg =(int) ((red*0.5) + (green * 0.2) + (blue * 0.3));
                    gray = alpha | avg << 16 | avg << 8 | avg;
                    prosesimage.setRGB(x, y, gray);
                }
            }
    ...
    if (jLabel1.getIcon()==null) {
            ...
            for (int x = 0; x < size.width; x++) {
                for (int y = 0; y < size.height; y++) {
                    ...
                    green = (RGB >> 8) & 0xFF;
                    blue = (RGB >>0) & 0xFF;
                    avg =(int) ((red*0.2) + (green * 0.3) + (blue * 0.5));
                    gray = alpha | avg << 16 | avg << 8 | avg;
                    prosesimage.setRGB(x, y, gray);
                }
            }
    ...
    //mengambil serta mengatur gambar yang akan diedit
    image = new ImageIcon(sumbergambar).getImage();
    size = new Dimension();
    size.width = image.getWidth(null);
    size.height = image.getHeight(null);
        setPreferredSize(size);
    //mengatur kembali ukuran gambar yang diperoleh    
    prosesimage = new BufferedImage(size.width, size.height, BufferedImage.TYPE_INT_RGB);
    prosesimage3 = new BufferedImage(size.width, size.height, BufferedImage.TYPE_INT_RGB);
    g = prosesimage.getGraphics();
    g.drawImage(image, 0, 0, null);
    ...
    //set konversi warna dari gambar asli
    for (int x=0; x<size.width; x++){
        for ( int y=0; y<size.height; y++){
            RGB = prosesimage.getRGB(x, y);
            alpha = (RGB << 24) & 0xFF;
    ...
    for (int x=0; x<size.width; x++){
        for (int y=0; y<size.height; y++){
            ...
            prosesimage3.setRGB(x, y, grayeq);
        }
    }
    ...
    drawHistogram (prosesimage3,gb2);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
    //mengatur gambar yang akan diedit serta mengatur nilai dari kontras warna
    image = new ImageIcon(sumbergambar).getImage();
    int add = jSlider1.getValue();
    size = new Dimension();
    size.width = image.getWidth(null);
    size.height = image.getHeight(null);
        setPreferredSize(size);
    ...
    //menampilkan gambar hasil kontras dengan nilai tertentu
    jLabel2.setIcon(new ImageIcon(new ImageIcon(prosesimage).getImage().getScaledInstance(jLabel2.getWidth(), jLabel2.getHeight(), Image.SCALE_DEFAULT)));
    drawHistogram(prosesimage,gb2);
    drawHistogram();
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
    //mengatur gambar yang akan diedit serta mengatur nilai dari brigness warna 
    image = new ImageIcon(sumbergambar).getImage();
    int add = jSlider2.getValue();
    size = new Dimension();
    size.width = image.getWidth(null);
    size.height = image.getHeight(null);
        setPreferredSize(size);
    ...
    //mengatur gambar yang akan diedit 
    image = new ImageIcon(sumbergambar).getImage();
    size = new Dimension();
    size.width = image.getWidth(null);
    size.height = image.getHeight(null);
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        ...
        for (int v = 1; v <= size.height - 2; v++) {
            for (int u = 1; u <= size.width - 2; u++) {
                ...
                for (int j = -1; j <= 1; j++) {
                    for (int i = -1; i <= 1; i++) {
                        RGB = prosesimage.getRGB(u + i, v + j);
                        alpha = (RGB << 24) & 0xFF;
                        red = (RGB >> 16) & 0xFF;
                        temp = alpha;
                        sum = sum + red;
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        ...
        g.drawImage(image, 0, 0, null);
        double filter[][] = {
            {0.025, 0.050, 0.100, 0.050, 0.025},
            {0.050, 0.075, 0.125, 0.075, 0.050},
            {0.100, 0.125, 0.200, 0.125, 0.100},
            {0.050, 0.075, 0.125, 0.075, 0.050},
            {0.025, 0.050, 0.100, 0.050, 0.025}
        };
    ...
    private void jMenuItem17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem17ActionPerformed
        ...
        try {
            ...
            jLabel2.setIcon(new ImageIcon(new ImageIcon(imagebuff3).getImage().getScaledInstance(jLabel2.getWidth(), jLabel2.getHeight(), Image.SCALE_DEFAULT)));
    ...
    public void drawHistogram(BufferedImage test, String jd1){
    ...
    public void drawHistogram(){
        ...
        try {
            test2 = ImageIO.read(new File(sumbergambar));
        } catch (Exception e) {
            System.out.println(e);
        }
